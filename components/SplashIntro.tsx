...
const SplashIntro: React.FC<SplashIntroProps> = ({ onComplete }) => {
  ...
  return (
    <div className={`fixed inset-0 z-[100] bg-navy-900 transition-opacity duration-1000 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}>
      {/* Video Background - Wholesome traditional couple representation */}
      <video
        autoPlay
        muted
        loop
      ...
      {/* Overlay Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-navy-900/40 via-transparent to-navy-900"></div>
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="absolute bottom-12 flex items-center gap-8 text-[10px] font-bold text-gold-500/60 uppercase tracking-[0.3em]">
          ...
          <span className="w-1.5 h-1.5 bg-gold-500/30 rounded-full"></span>
